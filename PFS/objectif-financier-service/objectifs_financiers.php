...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="http://localhost:9080/index.php">Accueil</a></li>
                <li><a href="http://localhost:9086/espace_personnel.php">Espace Personnel</a></li>
                <li><a href="http://localhost:9084/objectifs_financiers.php">Objectifs Financiers</a></li>
                <li><a href="http://localhost:9085/alertes.php">Alertes</a></li>
                <li><a href="http://localhost:9087/transactions.php">Transactions</a></li>
                <li><a href="http://localhost:9083/deconnexion.php">Déconnexion</a></li>
            </ul>
        </nav>
    </header>
    <div class="container">
