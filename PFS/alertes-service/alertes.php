    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="http://localhost:9086/index.php">Espace Personnel</a></li>
                <li><a href="http://localhost:9084/index.php">Objectifs Financiers</a></li>
                <li><a href="http://localhost:9085/index.php">Alertes</a></li>
                <li><a href="http://localhost:9087/index.php">Transactions</a></li>
                <li><a href="http://localhost:9083/index.php">Déconnexion</a></li>
            </ul>
        </nav>
    </header>
    <main>
